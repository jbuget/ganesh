# Monday ↔ Ganesh mapping (groundwork for V1.1)
...
1. **One way**: Ganesh → Monday. A value typed into Monday is overwritten,
...
Ganesh's phase statuses (`exploration`, `scoping`, `development`,
