 ...
 *
 * Two bands stacked, never merged: what is declared is solid, what the
 * projection added is hatched. The distinction is the whole reading — one is a
 * fact, the other a hypothesis, and steering must never take one for the other.
 *
...
export function PersonLoadCell({
  ...
  return (
    <div
      ...
      title={`${formatDecimalDays(booked)} j déclarés, ${formatDecimalDays(projected)} j projetés sur ${formatDecimalDays(capacity)} j`}
    >
      <span
        className={[
