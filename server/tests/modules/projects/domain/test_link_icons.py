...
@pytest.mark.parametrize(
    ("url", "attendue"),
    [
        ("https://github.com/waat/timesheet", "depot"),
        ("https://gitlab.com/waat/timesheet", "depot"),
        ("https://www.figma.com/file/abc/Maquettes", "maquette"),
        ("https://waat.slack.com/archives/C123", "discussion"),
        ("https://waat.monday.com/boards/42", "ticket"),
        ("https://drive.google.com/drive/folders/abc", "dossier"),
        ("https://waat.sharepoint.com/sites/projets", "dossier"),
...
def test_a_known_service_is_recognised(url: str, attendue: str) -> None:
    assert deviner_icone(url) == attendue
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://docs.google.com/spreadsheets/d/abc/edit", "tableur"),
...
def test_a_subdomain_is_recognised_like_its_domain() -> None:
    assert deviner_icone("https://pages.github.com/waat") == "depot"


def test_the_host_is_read_without_regard_to_case() -> None:
    assert deviner_icone("https://GitHub.com/waat") == "depot"
...
def test_an_unknown_address_falls_back_on_the_generic_icon(url: str) -> None:
    assert deviner_icone(url) == LinkIcon.LIEN
...
def test_an_address_that_only_resembles_a_known_service_is_not_matched() -> None:
    ...
    assert deviner_icone("https://monfigma.com/x") == LinkIcon.LIEN
